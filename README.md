...
- Delete Tasks: Deletes the tasks that are no longer needed
- Track Study Hours: Record daily study hours with date
- User friendly menu-driven interface
- All data is saved in text file
...
- Restart the program to confirm file persistence
